...
render() {
    ...
    return (
       ...
       <nav id="sidebar" className={"navbar-dark bg-grey "+this.state.active} >
      
            <div className="sidebar-header" id="header">
           
            <a href="/home" className="mt-2"> <img src={barter} alt="logo" id="imglogo"  />  </a>
        ...
        <button className="btn" type="button" id="sidebarCollapse" onClick={this.onClickToggle}><i className={"fa "+this.state.buttonClass}></i></button>    
