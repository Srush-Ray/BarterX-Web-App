...
import {getProductHistory,removeError,removeSuccess} from "../store/actions";
...
class ProductHistory extends Component {
  ...
  handleSubmit(event) {
    ...
    getProductHistory("?user_id="+usrid+"&orgName="+orgName,data)
    .then(
      () => 
      this.loadData(this.props.productHistory));
  }
      ...
      const {
        ...
        >
         ...
         <div className="card my-2">
            ...
            <b> Owner Name : </b>{Value.Owner}<br />
            <b> Category : </b>{Value.resource_type_id}<br />
            <b> Status : </b>{Value.Available}<br />
            <b> Owner Name : </b>{Value.Owner}<br />
            <b> Price : </b>{Value.Price}<br />
            <b> Timestamp : </b>{Timestamp}<br /> 
            <b> Is Delete : </b>{IsDelete}<br />            
            </div>
      </div>
        </div>
      );
    ...
    return (
        ...
        <div className="container-fluid">
        {
            ...
            <div className="form-row my-2">
              ...
              {this.state.showMessage && ( <div className="row">{this.renderCardData()}</div>)}
              <span className="mt-2" >
              <ErrorMessage />
            </span>
            </div>
...
export default connect((store)=>({
  ...
  productHistory:store.productHistory,
    ...
    getProductHistory,removeError,removeSuccess
})(ProductHistory);
