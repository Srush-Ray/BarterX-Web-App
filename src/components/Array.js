...
function Array (props)  {
    ...
    return (   
                ...
                <div className="item col-md-2 col-sm-4"  style={{border:'solid', marginRight:'1.5%', marginLeft:'1.5%', marginTop:'2%', borderRadius:'5%',padding:'2% 2%', backgroundColor:'#F1EFEF'}}>
                <img src={phone} style={{width:'95%', height:'50%', marginTop:'2.5%',marginLeft:'2.5%',marginRight:'2.5%', borderRadius:'5%'}}/>
