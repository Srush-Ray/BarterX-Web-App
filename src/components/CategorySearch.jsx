...
class CategorySearch extends Component {
    ...
    async componentDidMount(){
       let array=window.location.href.split("?")
        ...
        getCategory("?user_id="+usrid+"&orgName="+orgName+"&category="+category)
        .then(
          () => 
    ...
    renderCardData() {
      return this.state.products.map((product) => {
        ...
        return (
         ...
         <CardImg src={phone} alt="" style={{height:"170px",padding:"20px"}} />
          <CardBody>
            <CardText><b>Owner : </b>{Owner}</CardText>
            <CardText><b>Available : </b>{Available}</CardText>
